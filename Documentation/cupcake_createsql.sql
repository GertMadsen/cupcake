...
CREATE VIEW cupcake.vieworderlinedetails AS
SELECT * FROM cupcake.orderdetails JOIN cupcake.orderlines ON orderdetails.orderlines_orderline_id = orderlines.orderline_id;
